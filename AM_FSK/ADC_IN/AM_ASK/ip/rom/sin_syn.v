...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="NO" INIT_FILE="sin.mif" NUMWORDS_A=256 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" WIDTH_A=7 WIDTH_BYTEENA_A=1 WIDTHAD_A=8 address_a clock0 q_a
...
`endif
	...
	defparam
		...
		ram_block1a_0.mem_init0 = 256'hCC66C929552D98FFFE3369552926CC66CC66C929552D98FFFE3369552926CC66,
		...
		ram_block1a_0.port_a_logical_ram_width = 7,
	...
	defparam
		...
		ram_block1a_1.mem_init0 = 256'h96B4924D99CE1F0001F0E73364925AD25AD25B64CCE387FFFFC38E664DB496B4,
		...
		ram_block1a_1.port_a_logical_ram_width = 7,
	...
	defparam
		...
		ram_block1a_2.mem_init0 = 256'hE738E38E1E0FE000000FE0F0E38E39CE39CE38E3C3E07FFFFFFC0F878E38E738,
		...
		ram_block1a_2.port_a_logical_ram_width = 7,
	...
	defparam
		...
		ram_block1a_3.mem_init0 = 256'hF83F03F01FF0000000001FF01F81F83E07C1F81FC01FFFFFFFFFF007F03F07C0,
		...
		ram_block1a_3.port_a_logical_ram_width = 7,
	...
	defparam
		...
		ram_block1a_4.mem_init0 = 256'hFFC003FFE00000000000000FFF8007FE003FF8003FFFFFFFFFFFFFF8003FF800,
		...
		ram_block1a_4.port_a_logical_ram_width = 7,
	...
	defparam
		...
		ram_block1a_5.mem_init0 = 256'hFFFFFC000000000000000000007FFFFE000007FFFFFFFFFFFFFFFFFFFFC00000,
		...
		ram_block1a_5.port_a_logical_ram_width = 7,
	...
	defparam
		...
		ram_block1a_6.mem_init0 = 256'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE00000000000000000000000000000000,
		...
		ram_block1a_6.port_a_logical_ram_width = 7,
		ram_block1a_6.ram_block_type = "AUTO",
		ram_block1a_6.lpm_type = "cycloneive_ram_block";
	assign
		address_a_wire = address_a,
		q_a = {wire_ram_block1a_6portadataout[0], wire_ram_block1a_5portadataout[0], wire_ram_block1a_4portadataout[0], wire_ram_block1a_3portadataout[0], wire_ram_block1a_2portadataout[0], wire_ram_block1a_1portadataout[0], wire_ram_block1a_0portadataout[0]};
endmodule //sin_altsyncram
//VALID FILE
...
`endif
	...
	sin_altsyncram	sin_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
