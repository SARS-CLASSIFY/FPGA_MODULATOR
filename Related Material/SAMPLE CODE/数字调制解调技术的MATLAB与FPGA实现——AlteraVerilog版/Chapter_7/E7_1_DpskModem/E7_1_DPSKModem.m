...
%Invalid file identifier
%请根据需要修改下面语句，以改变文件名及文件存放路径
fid=fopen('D:\ModemPrograms\Chapter_7\E7_1_DpskModem\tra_lpf.txt','w');
fprintf(fid,'%12.12f\r\n',Shape_b);
fclose(fid);
...
%Invalid file identifier
%请根据需要修改下面语句，以改变文件名及文件存放路径
fid=fopen('D:\ModemPrograms\Chapter_7\E7_1_DpskModem\rec_lpf.txt','w');
fprintf(fid,'%12.12f\r\n',rec_lpf);
fclose(fid);
