...
%Input Data Width:	8
%FIR Width (Full Calculation Width Before Output Width Adjust) :   18
%-----------------------------------------------------------------------------------------------------------

	%MegaWizard Scaled Coefficient Values
	function  output = h_bpf_mlab_mat (stimulation, output)
	coef_matrix=[-1 0 -5 0 -5 0 6 0 27 0 36 0 -10 0 -255 0 255 0 10 0 -36 0 -27 0 -6 0 5 0 5 0 1 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 1; 
	MSB_RM  = 0;
	MSB_TYPE  = 0;
