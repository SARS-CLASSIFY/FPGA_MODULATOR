...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="h_bpf_ast" >
...
// Retrieval info:      <PRIVATE name = "coefficient_scaling_factor" value="455.8670973094487"  type="STRING"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "output_bits_right_of_binary_point" value="15"  type="INTEGER"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "device_family" value="Cyclone IV GX"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "set_1" value="Low Pass Set, Imported, D:\ModemPrograms\Chapter_7\E7_9_PiQpskModem\h_bpf.txt, -0.0032245344, 0.0, -0.011716707, -0.0, -0.011768422, 0.0, 0.01346107, -0.0, 0.06071884, 0.0, 0.079029635, -0.0, -0.02361755, 0.0, -0.55937356, 0.0, 0.55937356, -0.0, 0.02361755, 0.0, -0.079029635, -0.0, -0.06071884, 0.0, -0.01346107, -0.0, 0.011768422, 0.0, 0.011716707, -0.0, 0.0032245344"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "output_full_bits_right_of_binary_point" value="15"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "coefficient_reload_bit_width" value="10"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "logic_cell" value="908"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "dsp_block" value="31"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="h_bpf.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// RELATED_FILES: h_bpf_st.v, h_bpf_constraints.tcl, h_bpf_ast.vhd, h_bpf.v, h_bpf_ast.vhd, h_bpf.v;
// IPFS_FILES: h_bpf.vo;
// =========================================================
