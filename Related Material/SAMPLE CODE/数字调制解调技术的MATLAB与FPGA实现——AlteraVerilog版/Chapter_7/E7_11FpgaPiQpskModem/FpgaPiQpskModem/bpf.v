...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="bpf_ast" >
...
// Retrieval info:      <PRIVATE name = "coefficient_scaling_factor" value="371.6500817150811"  type="STRING"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "set_1" value="Low Pass Set, Imported, D:\ModemPrograms\Chapter_7\E7_9_PiQpskModem\bpf.txt, 0.0, -0.0033977046, -0.0, 0.0042160926, -0.0, 0.023738235, 0.0, 0.031935368, 0.0, -0.013908823, 0.0, -0.12739295, -0.0, -0.2564317, -0.0, 0.6861293, -0.0, -0.2564317, -0.0, -0.12739295, 0.0, -0.013908823, 0.0, 0.031935368, 0.0, 0.023738235, -0.0, 0.0042160926, -0.0, -0.0033977046, 0.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "logic_cell" value="874"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "dsp_block" value="16"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="bpf.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// RELATED_FILES: bpf_st.v, bpf_constraints.tcl, bpf_ast.vhd, bpf.v, bpf_ast.vhd, bpf.v;
// IPFS_FILES: bpf.vo;
// =========================================================
