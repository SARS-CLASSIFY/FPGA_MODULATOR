...
% 将成形滤波器、Hilbert滤波器、普通带通滤波器的系数1分别
% 写入Shape_lpf.txt、h_bpf.txt、bpf.txt文件中
...
%Invalid file identifier
%请根据需要修改下面语句，以改变文件名及文件存放路径
fid=fopen('D:\ModemPrograms\Chapter_7\E7_9_PiQpskModem\Shape_lpf.txt','w');
fprintf(fid,'%12.12f\r\n',Shape_b);
fclose(fid);



%将Hilbert滤波器系数写入b_bpf.txt文件中
%滤波系数进行10bit量化
...
%Invalid file identifier
%请根据需要修改下面语句，以改变文件名及文件存放路径
fid=fopen('D:\ModemPrograms\Chapter_7\E7_9_PiQpskModem\h_bpf.txt','w');
fprintf(fid,'%12.12f\r\n',h_bpf);
fclose(fid);
...
%Invalid file identifier
%请根据需要修改下面语句，以改变文件名及文件存放路径
fid=fopen('D:\ModemPrograms\Chapter_7\E7_9_PiQpskModem\bpf.txt','w');
fprintf(fid,'%12.12f\r\n',bpf);
fclose(fid);
