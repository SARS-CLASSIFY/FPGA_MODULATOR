...
%Invalid file identifier
%请根据需要修改下面语句，以改变文件名及文件存放路径
fid=fopen('D:\ModemPrograms\Chapter_7\E7_3_DqpskModem\tra_Lpf.txt','w');
fprintf(fid,'%12.12f\r\n',Shape_b);
fclose(fid);

%将接收滤波器系数写入rec_Lpf.txt文件中
%滤波系数进行10bit量化
...
%Invalid file identifier
%请根据需要修改下面语句，以改变文件名及文件存放路径
fid=fopen('D:\ModemPrograms\Chapter_7\E7_3_DqpskModem\rec_Lpf.txt','w');
fprintf(fid,'%12.12f\r\n',rec_lpf);
fclose(fid);