...
module nco (
	...
	input	[30:0]	phi_inc_i;
	input		clk;
	input		reset_n;
	input		clken;
	input	[30:0]	freq_mod_i;
	output	[9:0]	fsin_o;
	output	[9:0]	fcos_o;
	output		out_valid;
...
// Retrieval info:      <PRIVATE name = "FSAMP_VALUE" value="49.6"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "APRF" value="31"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "PHI_INC" value="346368330"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "FREQ_INC" value="134217728"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MPR" value="10"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "APR" value="31"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RAW" value="7"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RDW" value="9"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RNW" value="128"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MAX" value="1152"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSF" value="nco_sin.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSV" value="nco_sin.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSH" value="nco_sin.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCF" value="nco_cos.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCV" value="nco_cos.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCH" value="nco_cos.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_LCELLS" value="414"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_MEM_BITS" value="2304"  type="STRING"  enable="1" />
...
// Retrieval info:     <PORT name = "phi_inc_i" direction="INPUT"  connect_to="phi_inc_i"  default="NODEFVAL"  high_width="30"  low_width="0"  description="" />
...
// Retrieval info:     <PORT name = "freq_mod_i" direction="INPUT"  connect_to="freq_mod_i"  default="NODEFVAL"  high_width="30"  low_width="0"  description="" />
// Retrieval info:    </PORTS>
