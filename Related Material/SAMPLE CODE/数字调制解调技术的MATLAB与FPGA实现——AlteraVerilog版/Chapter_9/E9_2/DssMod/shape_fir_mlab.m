...
%Input Data Width:	2
%FIR Width (Full Calculation Width Before Output Width Adjust) :   15
%-----------------------------------------------------------------------------------------------------------

	%MegaWizard Scaled Coefficient Values
	function  output = shape_fir_mlab_mat (stimulation, output)
	coef_matrix=[0 0 -2 -9 -18 -27 -30 -23 0 43 107 188 279 368 443 493 511 493 443 368 279 188 107 43 0 -23 -30 -27 -18 -9 -2 0 0 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 1; 
	MSB_RM  = 0;
	MSB_TYPE  = 0;
