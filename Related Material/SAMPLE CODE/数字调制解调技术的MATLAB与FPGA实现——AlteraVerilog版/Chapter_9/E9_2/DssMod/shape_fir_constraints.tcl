...
proc add_fir_constraints {args} {
	...
	set_global_assignment -name "DSP_BLOCK_BALANCING" -remove -entity "shape_fir_st"
	...
	set_global_assignment -name "DSP_BLOCK_BALANCING" -entity "shape_fir_st" "LOGIC ELEMENTS"
}
add_fir_constraints
