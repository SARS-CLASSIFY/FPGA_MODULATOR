...
% file : nco8m_tb.m
%
% Description : The following Matlab testbench excercises the NCO model nco8m_model.m
...
[sin_out,cos_out] = nco8m_model(phi_inc_i,phase_mod_i,freq_mod_i);
fid_s = fopen('fsin_o_nco8m_matlab.txt','w');
for i=1:N
  fprintf(fid_s,'%f\n',sin_out(i));
end
