...
%Input Data Width:	15
%FIR Width (Full Calculation Width Before Output Width Adjust) :   29
%-----------------------------------------------------------------------------------------------------------

	%MegaWizard Scaled Coefficient Values
	function  output = bpf1_mlab_mat (stimulation, output)
	coef_matrix=[-28 -24 7 57 72 25 4 129 303 173 -466 -1214 -1247 -177 1334 2046 1334 -177 -1247 -1214 -466 173 303 129 4 25 72 57 7 -24 -28 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 1; 
	MSB_RM  = 0;
	MSB_TYPE  = 0;
