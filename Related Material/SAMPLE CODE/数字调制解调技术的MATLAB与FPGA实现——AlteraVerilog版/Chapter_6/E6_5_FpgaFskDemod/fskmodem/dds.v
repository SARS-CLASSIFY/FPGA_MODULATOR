...
// Retrieval info: <MEGACORE title="NCO"  version="12.1"  build="177"  iptb_version="1.3.0 Build 177"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION active_core="dds_st" >
...
// Retrieval info:      <PRIVATE name = "FSAMP_VALUE" value="32"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "FREQ_VALUE" value="6"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "APRF" value="25"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "PHI_INC" value="6291456"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MODULE_NAME" value="dds_st"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NETLIST_FILE_NAME" value="dds_st.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "PHASE_INC" value="4096"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "FREQ_INC" value="2097152"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MPR" value="15"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "APR" value="25"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RAW" value="12"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RDW" value="14"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RNW" value="4096"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MAX" value="57344"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSF" value="dds_sin.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSV" value="dds_sin.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSH" value="dds_sin.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCF" value="dds_cos.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCV" value="dds_cos.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCH" value="dds_cos.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_LCELLS" value="513"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_MEM_BITS" value="114688"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_EABS" value="14"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="dds.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="dds_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:     <PORT name = "phi_inc_i" direction="INPUT"  connect_to="phi_inc_i"  default="NODEFVAL"  high_width="24"  low_width="0"  description="" />
// Retrieval info:     <PORT name = "fsin_o" direction="OUTPUT"  connect_to="fsin_o"  default="NODEFVAL"  high_width="14"  low_width="0"  description="" />
// Retrieval info:     <PORT name = "fcos_o" direction="OUTPUT"  connect_to="fcos_o"  default="NODEFVAL"  high_width="14"  low_width="0"  description="" />
...
// Retrieval info:     <PORT name = "freq_mod_i" direction="INPUT"  connect_to="freq_mod_i"  default="NODEFVAL"  high_width="24"  low_width="0"  description="" />
// Retrieval info:    </PORTS>
