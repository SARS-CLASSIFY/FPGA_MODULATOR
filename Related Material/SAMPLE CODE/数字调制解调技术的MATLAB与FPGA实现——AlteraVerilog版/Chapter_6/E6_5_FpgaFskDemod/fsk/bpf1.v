...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="bpf1_ast" >
...
// Retrieval info:      <PRIVATE name = "coefficient_scaling_factor" value="9282.070169670342"  type="STRING"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "set_1" value="Low Pass Set, Imported, D:\ModemPrograms\Chapter_6\E6_5_FpgaFskDemod\bpf1.txt, -0.0030906058, -0.0026063526, 8.416131E-4, 0.0062064542, 0.007828657, 0.0027225597, 4.6899443E-4, 0.013952815, 0.032733552, 0.018680403, -0.050263125, -0.13085382, -0.13443944, -0.0191607, 0.14374392, 0.2205327, 0.14374392, -0.0191607, -0.13443944, -0.13085382, -0.050263125, 0.018680403, 0.032733552, 0.013952815, 4.6899443E-4, 0.0027225597, 0.007828657, 0.0062064542, 8.416131E-4, -0.0026063526, -0.0030906058"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="bpf1.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// RELATED_FILES: bpf1_st.v, bpf1_constraints.tcl, bpf1_ast.vhd, bpf1.v, bpf1_ast.vhd, bpf1.v;
// IPFS_FILES: bpf1.vo;
// =========================================================
