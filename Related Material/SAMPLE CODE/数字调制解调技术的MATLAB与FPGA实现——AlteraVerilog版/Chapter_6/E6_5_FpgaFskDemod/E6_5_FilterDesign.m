...
fid=fopen('D:\ModemPrograms\Chapter_6\E6_5_FpgaFskDemod\bpf1.txt','w');
fprintf(fid,'%12.12f\r\n',Bpf1);
fclose(fid);

fid=fopen('D:\ModemPrograms\Chapter_6\E6_5_FpgaFskDemod\bpf2.txt','w');
fprintf(fid,'%12.12f\r\n',Bpf2);
fclose(fid);

fid=fopen('D:\ModemPrograms\Chapter_6\E6_5_FpgaFskDemod\lpf.txt','w');
fprintf(fid,'%12.12f\r\n',Lpf);
fclose(fid);
