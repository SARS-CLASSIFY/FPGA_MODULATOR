...
% file : dds_tb.m
%
% Description : The following Matlab testbench excercises the NCO model dds_model.m
...
phi_inc_i = 6291456.*ones(1,N);
% freq_mod_i : frequency modulation input : Length N (optional)
freq_mod_i = 2097152.*ones(1,N);
% phase_mod_i : phase modulation input : Length N (optional)
phase_mod_i = zeros(1,N);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function call to generated nco function
[sin_out,cos_out] = dds_model(phi_inc_i,phase_mod_i,freq_mod_i);
fid_s = fopen('fsin_o_dds_matlab.txt','w');
fid_c = fopen('fcos_o_dds_matlab.txt','w');
for i=1:N
  fprintf(fid_s,'%f\n',sin_out(i));
  fprintf(fid_c,'%f\n',cos_out(i));
end
