...
module fskmode_nco_ii_0(clk, reset_n, clken, phi_inc_i, freq_mod_i, fsin_o, out_valid);
...
parameter raw = 12;
parameter rnw = 4096;
parameter rsf = "fskmode_nco_ii_0_sin.hex";
parameter rcf = "fskmode_nco_ii_0_cos.hex";
parameter nc = 1;
parameter log2nc =0;
