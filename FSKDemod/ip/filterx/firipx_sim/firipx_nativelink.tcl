## ================================================================================
## Legal Notice: Copyright (C) 2022 Intel Corporation. All rights reserved.
...
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.firipx_tb -section_id tb
...
if {[file exists $file_dir/firipx_coef_reload.txt]} {
  set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/firipx_coef_reload.txt -section_id tb -library work
}
if {[file exists $file_dir/firipx_coef_reload_rtl.txt]} {
  set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/firipx_coef_reload_rtl.txt -section_id tb -library work
}
set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/firipx_input.txt -section_id tb -library work

set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/firipx_tb.vhd -section_id tb -library work
